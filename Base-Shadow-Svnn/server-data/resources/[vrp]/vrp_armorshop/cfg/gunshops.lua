...
cfg.gunshop_types = {
  ["melees"] = {
    ...
    ["WEAPON_BAT"] = {"Bat",1000,0,""},
    ["WEAPON_KNUCKLE"] = {"Knuckle",2000,0,""},
    ["WEAPON_KNIFE"] = {"Knife",3000,0,""},
    ["ARMOR"] = {"Body Armor",40000,0,""}
  },
